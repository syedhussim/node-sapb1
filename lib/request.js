...
module.exports = {
     ...
     */
    execute(method, url, params, success = () => {}, error = () => {}, cookies = {}, cacert, headers = {}){
        ...
        var options = {
            ...
            path : url,
            method : method,
            headers : Object.assign({ 'User-Agent' : 'SAPb1Client', 'Content-Type': 'application/json; charset=UTF-8', 'Content-Length': Buffer.byteLength(postData, 'utf8') }, headers),
            ca : cacert
        };
